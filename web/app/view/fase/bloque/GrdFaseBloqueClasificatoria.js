Ext.define('SGCEscalada.view.fase.bloque.GrdFaseBloqueClasificatoria', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.grdFaseBloqueClasificatoria',
    store: Ext.create('SGCEscalada.store.fase.bloque.FaseBloqueStore'),/**FALTA CAMBIARLE EL STORE*/
    bloque:true,
    columnLines: true,
    selType: 'cellmodel',
    ...
    columns: [
        ...
        {text: 'T5', dataIndex: 't5', align: 'center', width: 55},
        {text: 'B5', dataIndex: 'b5', align: 'center', width: 55},
    ...
    initComponent: function () {
        ...
        if (!cliente) {
            ...
            me.columns[11].editor = {xtype: 'numberfield',minValue: 0,maxValue: 25};
            me.columns[12].editor = {xtype: 'numberfield',minValue: 0,maxValue: 25};

            /*me.columns[13].editor = {xtype: 'numberfield',minValue: 0};
            me.columns[14].editor = {xtype: 'numberfield',minValue: 0};
            me.columns[15].editor = {xtype: 'numberfield',minValue: 0};
            me.columns[16].editor = {xtype: 'numberfield',minValue: 0};*/
        }
